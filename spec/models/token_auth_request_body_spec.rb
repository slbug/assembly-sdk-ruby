...
# Unit tests for AssemblyPayments::TokenAuthRequestBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AssemblyPayments::TokenAuthRequestBody do
  let(:instance) { AssemblyPayments::TokenAuthRequestBody.new }

  describe 'test an instance of TokenAuthRequestBody' do
    it 'should create an instance of TokenAuthRequestBody' do
      expect(instance).to be_instance_of(AssemblyPayments::TokenAuthRequestBody)
    end
  end
