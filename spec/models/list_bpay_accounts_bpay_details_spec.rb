...
# Unit tests for AssemblyPayments::ListBpayAccountsBpayDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AssemblyPayments::ListBpayAccountsBpayDetails do
  let(:instance) { AssemblyPayments::ListBpayAccountsBpayDetails.new }
  ...
  describe 'test an instance of ListBpayAccountsBpayDetails' do
    it 'should create an instance of ListBpayAccountsBpayDetails' do
      expect(instance).to be_instance_of(AssemblyPayments::ListBpayAccountsBpayDetails)
    end
  end
