...
# Unit tests for AssemblyPayments::FeeRequestBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AssemblyPayments::FeeRequestBody do
  let(:instance) { AssemblyPayments::FeeRequestBody.new }

  describe 'test an instance of FeeRequestBody' do
    it 'should create an instance of FeeRequestBody' do
      expect(instance).to be_instance_of(AssemblyPayments::FeeRequestBody)
    end
  end
