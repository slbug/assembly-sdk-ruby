...
# Unit tests for AssemblyPayments::Callback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AssemblyPayments::Callback do
  let(:instance) { AssemblyPayments::Callback.new }

  describe 'test an instance of Callback' do
    it 'should create an instance of Callback' do
      expect(instance).to be_instance_of(AssemblyPayments::Callback)
    end
  end
