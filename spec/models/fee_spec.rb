...
# Unit tests for AssemblyPayments::Fee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AssemblyPayments::Fee do
  let(:instance) { AssemblyPayments::Fee.new }

  describe 'test an instance of Fee' do
    it 'should create an instance of Fee' do
      expect(instance).to be_instance_of(AssemblyPayments::Fee)
    end
  end
